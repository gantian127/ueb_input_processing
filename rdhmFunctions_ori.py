"""
This is used for old version of model input preparation
"""
__author__ = 'tsega'
try:
...
def create_multiple_Ascii_fromNetCDF(input_netCDF, output_prefix, input_varName, time_length, dThour = 3,
